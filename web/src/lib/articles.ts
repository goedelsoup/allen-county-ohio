...
export const ARTICLES: Article[] = [
  ...
  {
    slug: 'the-ground-that-did-not-move',
    title: 'The ground that did not move',
    dek: 'Ninety-seven and a half per cent of Allen County was filed under the same land cover class in 2021 as in 2001 \u2014 and the ground that did move mostly got denser rather than newly built.',
    section: 'ground',
    era: [2001, 2021],
    assertions: [
      'seventy-per-cent-farmed-and-nineteen-developed',
      'ninety-seven-and-a-half-per-cent-did-not-change',
      'the-boundary-is-the-control',
      'pasture-is-the-class-that-fell',
      'eight-acres-of-forest-in-twenty-years',
      'nineteen-hundred-acres-in-and-sixteen-hundred-off-farmland',
      'the-county-thickened-rather-than-spread',
      'the-largest-transition-is-not-farm-to-town',
      'more-acres-got-denser-than-got-built',
      'six-per-cent-of-the-county-is-paved',
      'the-thickening-paved-as-much-as-the-building',
      'not-one-acre-moved-the-other-way',
      'a-pixel-is-not-a-building',
      'four-per-cent-of-the-swamp-is-still-wet',
      'the-drainage-was-ninety-six-per-cent-complete',
      'two-instruments-disagree-about-marsh-by-eighteen',
      'the-producer-named-the-file-to-use-instead',
      'four-columns-that-were-never-a-second-opinion',
      'one-epoch-boundary-is-a-mapping-change',
      'a-category-is-not-a-land-use',
    ],
    entries: [
  ...
  {
    slug: 'seven-thousand-more-front-doors',
    title: 'Seven thousand more front doors',
    dek: 'Allen County lost 8,938 people between 1970 and 2020 and gained 6,969 households. Persons per household fell from 3.20 to 2.41, and ten thousand of the county\u2019s occupied dwellings exist because of it.',
    section: 'people',
    era: [1970, 2023],
    assertions: [
      'the-county-gained-households-and-lost-people',
      'household-size-fell-a-quarter-with-no-reversal',
      'ten-thousand-dwellings-nobody-arrived-for',
      'almost-all-the-household-growth-is-one-decade',
      'married-couple-households-peaked-in-1980',
      'one-person-households-more-than-doubled',
      'four-and-a-quarter-to-one-became-one-and-a-half',
      'a-household-and-an-occupied-unit-are-one-number',
      'three-printed-volumes-check-the-compendium',
      'one-cell-of-that-table-is-in-thousands',
      'the-survey-and-the-census-part-company-by-a-ninth',
      'a-third-of-this-countys-households-are-one-person',
      'seventh-of-eighty-eight-and-eighty-first',
      'putnam-is-lowest-in-ohio-and-allen-is-fourteenth',
      'the-city-does-not-account-for-all-of-it',
      'from-seventy-per-cent-to-twenty-six',
      'seven-columns-thirteen-rows-no-residual',
      'in-lima-a-rented-house-holds-more-people',
      'lone-parents-outnumber-married-couples-in-lima',
      'six-times-as-likely-to-be-poor',
      'two-thirds-of-poor-families-and-a-fifth-of-families',
      'grandparents-raising-grandchildren',
      'thirteen-hundred-households-of-three-generations',
      'the-first-count-of-same-sex-couples',
      'fewer-than-half-the-countys-adults-are-married',
      'more-divorced-than-the-state-and-the-nation',
      'half-the-men-in-lima-have-never-married',
      'more-married-men-than-married-women',
    ],
    entries: [
      'measure/allen-county-households-1970-2023.yml',
      'measure/allen-county-household-composition-2023.yml',
      'measure/allen-county-households-by-place-2020.yml',
      'measure/allen-county-marital-status-2023.yml',
    ],
  },
  {
    slug: 'whose-deaths-these-were',
    title: 'Whose deaths these were',
    dek: 'Eight hundred and fifteen people died of COVID-19 in Allen County and five hundred and thirteen of them lived there \u2014 the largest gap between the two of any county in Ohio.',
    section: 'people',
    era: [2020, 2023],
    assertions: [
      'five-hundred-and-seventeen-residents-died',
      'sixteenth-of-eighty-eight-on-covid-deaths',
      'the-second-winter-killed-more-than-the-first',
      'only-forty-two-deaths-after-february-2022',
      'covid-was-a-sixth-of-the-countys-deaths',
      'the-fall-in-deaths-is-the-fall-in-covid',
      'eighty-three-per-cent-of-the-dead-were-sixty-or-over',
      'one-in-ten-over-eighty-and-one-in-five-thousand-under-twenty',
      'more-women-caught-it-and-more-men-died',
      'thirty-four-thousand-cases-and-two-thousand-admissions',
      'fifth-of-eighty-eight-on-hospitalisations',
      'one-case-in-fifteen-went-to-hospital',
      'the-biggest-month-was-not-the-worst',
      'two-hundred-and-ninety-two-admissions-with-no-date',
      'eight-hundred-and-fifteen-died-here-five-hundred-and-thirteen-lived-here',
      'first-of-eighty-two-on-the-ratio',
      'four-of-five-neighbours-run-the-other-way',
      'at-the-state-line-the-two-counts-agree',
      'the-county-carries-a-third-more-dying-than-its-people-do',
      'ninety-six-of-a-hundred-and-seventy-weeks-suppressed',
      'forty-five-per-cent-completed-a-course',
      'eighty-two-per-cent-of-the-old-and-sixteen-of-the-young',
      'ohios-counties-run-from-nineteen-to-seventy-nine',
      'half-the-vaccinated-took-a-booster',
      'limas-codes-ran-half-again-blufftons',
      'the-zip-file-and-the-county-file-agree',
      'the-states-zip-populations-are-not-the-censuss',
    ],
    entries: [
      'measure/allen-county-covid-deaths-2020-2023.yml',
      'measure/allen-county-covid-place-of-death-2020-2023.yml',
      'measure/allen-county-covid-cases-2020-2023.yml',
      'measure/allen-county-covid-vaccination-2020-2023.yml',
      'measure/allen-county-covid-by-zip-2020-2023.yml',
    ],
  },
  {
    slug: 'where-the-choosing-starts',
    title: 'Where the choosing starts',
    dek: 'Two of Allen County\'s ten high schools offer an Advanced Placement course, and three of the 132 pupils taking one are Black.',
    section: 'people',
    era: [2013, 2021],
    assertions: [
      'two-of-ten-high-schools-offer-it',
      'half-of-ohios-high-schools-and-a-fifth-of-this-countys',
      'lima-senior-is-nineteenth-largest-of-the-schools-without-it',
      'six-four-four-five-two',
      'better-supplied-than-ohio-on-everything-but-one',
      'a-quarter-of-ohios-advanced-placement',
      'perry-dropped-physics-and-calculus',
      'four-of-ten-report-a-gifted-programme',
      'the-county-beat-ohio-on-certification-by-a-point',
      'allen-east-taught-half-its-classes-uncertified',
      'the-certification-question-was-retired-after-2017',
      'three-black-pupils-in-an-advanced-placement-course',
      'the-required-courses-are-taken-evenly',
      'the-elective-courses-are-not',
      'the-county-takes-more-science-than-ohio',
      'most-of-the-black-pupils-are-in-the-school-with-no-ap',
      'the-gap-survives-standardising-on-the-school',
      'between-schools-multiplies-by-one-point-six-and-inside-by-four-point-six',
      'inside-lima-the-ratio-is-five-to-one',
      'four-hundred-and-ninety-two-sat-a-college-course',
      'the-state-pays-for-one-and-the-family-for-the-other',
      'nearly-half-of-spencerville-is-in-a-college-course',
      'the-largest-high-school-uses-it-least',
      'white-pupils-are-three-and-a-half-times-as-likely',
      'bath-went-from-one-hundred-and-ninety-nine-to-none',
      'advanced-placement-fell-by-half-and-by-nine-tenths',
      'the-ratio-went-from-one-point-four-to-seven-point-six',
      'lima-enrolled-sixty-seven-in-2013',
      'the-four-that-changed-did-not-change-together',
      'the-pupils-did-not-leave',
      'the-substitution-replaced-a-quarter-of-the-seats',
    ],
    entries: [
      'measure/allen-county-course-offerings-2013-2021.yml',
      'measure/allen-county-advanced-coursework-2021.yml',
      'measure/allen-county-dual-enrollment-2017-2021.yml',
      'question/where-the-advanced-placement-went.yml',
    ],
  },
  {
    slug: 'in-the-countys-name',
    title: "In the county's name",
    dek: 'Two billion two hundred million dollars of bonds stand issued in Allen County\'s name for a hospital system, and the county owes none of it.',
    section: 'government',
    era: [2010, 2023],
    assertions: [
      'two-billion-in-the-countys-name',
      'what-a-conduit-issue-is',
      'every-itemised-issue-was-one-hospital-system',
      'first-in-ohio-on-industrial-revenue-debt',
      'two-instruments-within-three-per-cent',
      'nine-hundred-million-in-the-year-the-rule-changed',
      'the-federal-file-stopped-carrying-it',
      'forty-six-governments-raised-five-hundred-and-forty-six-million',
      'half-is-schools-and-a-thirtieth-is-townships',
      'three-governments-are-nearly-half',
      'a-special-district-is-whatever-ohio-made-a-government',
      'thirty-sixth-on-revenue-and-twenty-first-on-spending',
      'the-county-spends-more-than-it-raises',
      'two-hundred-and-eighty-seven-million-owed',
      'nine-carry-ninety-six-per-cent-of-the-debt',
      'the-county-owes-least-of-the-large-ones',
      'eighty-four-per-cent-that-did-not-happen',
      'a-factor-of-a-hundred-and-twelve',
      'long-term-debt-is-not-every-liability',
      'the-county-did-not-answer',
      'the-schools-answer-and-the-villages-do-not',
      'an-interest-rate-of-two-hundred-and-fifty-eight-per-cent',
      'the-auditor-says-two-hundred-and-six-thousand',
      'the-same-model-is-nearly-right-about-everything-large',
      'the-flag-travels-with-the-figure',
    ],
    entries: [
      'measure/allen-county-conduit-debt-2010-2023.yml',
      'measure/allen-county-local-government-finance-2022.yml',
      'measure/allen-county-local-government-debt-2017-2022.yml',
      'measure/allen-county-in-the-federal-finance-file-2022.yml',
    ],
  },
  {
    slug: 'born-in-the-book-died-in-the-paper',
    title: 'Born in the book, died in the paper',
    dek: "Two county histories sold four hundred pages of biography to the people in them. Reading that half gave twenty of this county's people a birthday, and a newspaper gave three of them an end.",
    section: 'history',
    era: [1804, 1921],
    assertions: [
      'the-books-are-half-biography',
      'eight-sketches-the-publisher-would-not-vouch-for',
      'the-head-of-a-sketch-is-the-man-who-bought-it',
      'one-sketch-in-four-hundred-pages-is-a-womans',
      'two-sketches-of-one-man-disagree',
      'a-class-that-declared-five-fields-and-used-one',
      'twenty-of-forty-eight',
      'born-in-the-book-died-in-the-paper',
      'what-finishes-a-life-is-a-newspaper',
      'lamison-dated-at-both-ends',
      'faurot-died-poor',
      'a-rounded-age-checks-a-birthday',
      'two-sources-agree-to-the-day',
      'one-node-held-two-men',
      'the-war-service-was-on-the-wrong-man',
      'brice-and-baxter-on-one-board',
      'a-doctor-a-bottler-and-a-sheriff',
      'a-scan-moved-a-birthday-five-years',
      'two-scans-agreeing-is-not-truth',
      'a-name-match-that-was-refused',
    ],
    entries: [
      'measure/allen-county-lives-in-the-county-histories.yml',
      'person/samuel-a-baxter.yml',
      'person/dr-samuel-a-baxter.yml',
      'person/charles-n-lamison.yml',
  ...
  {
    slug: 'the-same-map-twice',
    title: 'The same map twice',
    dek: "Allen County's mortgage register records who was refused and what the loan cost, and across the county's census tracts the two rank almost together. The tracts where credit is hardest to get are the tracts where it is dearest, and the tracts where there is least of it.",
    section: 'people',
    era: [2018, 2024],
    assertions: [
      'the-price-runs-with-the-size-of-the-loan',
      'what-a-higher-priced-loan-is',
      'the-closing-fee-barely-moves',
      'the-gradient-holds-inside-one-year',
      'ohio-prices-loans-by-their-size',
      'six-hundred-loans-with-no-price',
      'the-two-maps-are-nearly-one-map',
      'lending-is-not-spread-evenly-over-the-houses',
      'one-loan-for-nineteen-houses',
      'more-dollars-to-close-a-smaller-loan',
      'the-city-premium-stops-at-the-top',
      'one-lender-two-geographies',
      'size-does-not-explain-the-race-gap',
      'the-chattel-loan-is-not-a-mortgage',
      'half-the-manufactured-applications-are-refused',
      'a-hundred-and-one-on-rented-ground',
      'three-specialists-and-one-owner',
    ],
    entries: [
      'measure/allen-county-mortgage-prices-2018-2024.yml',
      'measure/allen-county-mortgage-access-by-tract-2018-2024.yml',
      'measure/allen-county-manufactured-home-lending-2018-2024.yml',
