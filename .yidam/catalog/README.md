...
| [allen-county-gis-downloads.md](allen-county-gis-downloads.md) | dataset | The county's own parcel, address and political-subdivision layers, published weekly as shapefiles. The first local-authority source in this corpus, and the only one that names buildings. | yes | 7 | 0 |
| [census-block-assignment-2020.md](census-block-assignment-2020.md) | dataset | The Census Bureau's block-level assignment of every 2020 census block to the congressional, state legislative, school and voting districts covering it. | yes | 32 | 0 |
...
| [tigerweb-census2020.md](tigerweb-census2020.md) | api | The Census Bureau's boundary geometry as a keyless ArcGIS REST service. This is the first source in this corpus that can answer "what is inside what" rather than "where is it, roughly". | yes | 41 | 0 |
