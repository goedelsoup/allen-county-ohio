...
| [allen-county-gis-downloads.md](allen-county-gis-downloads.md) | dataset | The county's own parcel, address and political-subdivision layers, published weekly as shapefiles. The first local-authority source in this corpus, and the only one that names buildings. | yes | 5 | 0 |
| [census-block-assignment-2020.md](census-block-assignment-2020.md) | dataset | The Census Bureau's block-level assignment of every 2020 census block to the congressional, state legislative, school and voting districts covering it. | yes | 27 | 0 |
...
| [census-gazetteer-2020.md](census-gazetteer-2020.md) | dataset | The Census Bureau's published gazetteer for the 2020 geographies — land and water area, internal-point coordinates, GEOID and ANSI codes for counties, county subdivisions, incorporated places and census tracts. | yes | 46 | 0 |
...
| [census-popest-2024.md](census-popest-2024.md) | dataset | The Census Bureau's annual population estimates for counties and sub-county units, Vintage 2024 — an April 2020 estimates base plus July 1 estimates for 2020 through 2024. | yes | 28 | 0 |
...
| [tigerweb-census2020.md](tigerweb-census2020.md) | api | The Census Bureau's boundary geometry as a keyless ArcGIS REST service. This is the first source in this corpus that can answer "what is inside what" rather than "where is it, roughly". | yes | 32 | 0 |
