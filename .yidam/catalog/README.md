...
| [allen-county-gis-downloads.md](allen-county-gis-downloads.md) | dataset | The county's own parcel, address and political-subdivision layers, published weekly as shapefiles. The first local-authority source in this corpus, and the only one that names buildings. | yes | 21 | 0 |
...
| [tigerweb-census2020.md](tigerweb-census2020.md) | api | The Census Bureau's boundary geometry as a keyless ArcGIS REST service. This is the first source in this corpus that can answer "what is inside what" rather than "where is it, roughly". | yes | 59 | 0 |
