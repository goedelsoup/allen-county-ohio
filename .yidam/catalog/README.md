...
| [census-block-assignment-2020.md](census-block-assignment-2020.md) | dataset | The Census Bureau's block-level assignment of every 2020 census block to the congressional, state legislative, school and voting districts covering it. | yes | 8 | 0 |
...
| [census-gazetteer-2020.md](census-gazetteer-2020.md) | dataset | The Census Bureau's published gazetteer for the 2020 geographies — land and water area, internal-point coordinates, GEOID and ANSI codes for counties, county subdivisions, incorporated places and census tracts. | yes | 35 | 0 |
...
| [tigerweb-census2020.md](tigerweb-census2020.md) | api | The Census Bureau's boundary geometry as a keyless ArcGIS REST service. This is the first source in this corpus that can answer "what is inside what" rather than "where is it, roughly". | yes | 9 | 0 |
