...
description: >-
  ...
  file carries 17,921 features, 113 of them filed under Allen County.
type: dataset
obtained: true
...
appear in Allen County's 113 rows — it is filed under Putnam, where it discharges. Filtering
on `county_name == "Allen"` and calling the result "the county's named features" would omit
the county's principal watercourse, and would do it silently.
