...
This repository's domain is **Allen County, Ohio** — a civic-reference corpus covering the
county's geography, its jurisdictions and offices, and its history from pre-statehood
through the present.
